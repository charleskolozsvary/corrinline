...
understand the failure of the ``Flat Orbit Conjecture'' in higher curvature regimes. <period: put foootnote after period>\footnote{
...
\section{Background and p <small cap>reliminaries}
